  ...
  return (
    <div className='flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8'>
      <div className='sm:mx-auto sm:w-full sm:max-w-sm'>
        <img className='mx-auto h-20 w-auto' src='/darklogo.jpeg' alt='M2 logo' />
      ...
      <div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
        <form className='space-y-6'>
          <div>
            <label htmlFor='username' className='block text-md leading-6 text-white'>
              Username
            </label>
            <div className='mt-2'>
              <input
                ...
                className='block w-full rounded-md border-0 p-2 text-secondary shadow-sm placeholder:text-gray-400 outline-none sm:text-sm sm:leading-6'
              />
            </div>
          </div>
          ...
          <div>
            <div className='flex items-center justify-between'>
              <label htmlFor='password' className='block text-md leading-6 text-white'>
                Password
              </label>
            </div>
            <div className='mt-2'>
